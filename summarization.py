...
tf.app.flags.DEFINE_string("data_dir", "D:\\Use Case Studies\\NLP\\Abstrative Summarization\\Project-1\\data", "Data directory")
tf.app.flags.DEFINE_string("test_file", "", "Test filename.")
tf.app.flags.DEFINE_string("test_output", "output.txt", "Test output.")
tf.app.flags.DEFINE_string("train_dir", "D:\\Use Case Studies\\NLP\\Abstrative Summarization\\Project-1\\model", "Training directory.")
...
tf.app.flags.DEFINE_integer("batch_size", 4, "Batch size in training / beam size in testing.")
...
tf.app.flags.DEFINE_integer("max_iter", 10000, "Maximum training iterations.")
tf.app.flags.DEFINE_integer("steps_per_validation", 1000, "Training steps between validations.")
tf.app.flags.DEFINE_integer("steps_per_checkpoint", 1000, "Training steps between checkpoints.")
