...
if __name__ == "__main__":
    ...
    docid, sumid, doc_dict, sum_dict = load_data(
        "D:\\Use Case Studies\\NLP\\Abstrative Summarization\\Project-1\\data\\train.article.txt", "D:\\Use Case Studies\\NLP\\Abstrative Summarization\\Project-1\\data\\train.title.txt",
        "D:\\Use Case Studies\\NLP\\Abstrative Summarization\\Project-1\\data\\doc_dict.txt", "D:\\Use Case Studies\\NLP\\Abstrative Summarization\\Project-1\\data\\sum_dict.txt",
        30000, 30000)
    ...
    docid, sumid = load_valid_data(
        "D:\\Use Case Studies\\NLP\\Abstrative Summarization\\Project-1\\data\\valid.article.filter.txt", "D:\\Use Case Studies\\NLP\\Abstrative Summarization\\Project-1\\data\\valid.title.filter.txt",
        doc_dict, sum_dict)
    ...
    docid = load_test_data("D:\\Use Case Studies\\NLP\\Abstrative Summarization\\Project-1\\data\\test.giga.txt", doc_dict)
    checkid = np.random.randint(len(docid))
    print(checkid)
    print(docid[checkid], sen_map2tok(docid[checkid], doc_dict[1]))
